const CACHE = 'fantasy-hq-jonin-4-4-11-4-projection-semantics-2026-09-19';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.4.11.4-correction-2',
  './js/app-version.js?v=1.0.31',
  ...
  './js/yahoo-season-v1.js?v=1.1.1-projection-semantics',
  './js/yahoo-sync-v1.js?v=1.1.0',
  './js/season-command-center-v1.js?v=1.1.6-projection-semantics',
  './js/season-home-v3.js?v=1.0.2',
  ...
  './js/app.js?v=4.4.11.4-season-home-v3-5-projection-semantics',
