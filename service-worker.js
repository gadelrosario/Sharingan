const CACHE = 'fantasy-hq-jonin-4-4-15-lineup-workspace-2026-09-24-identity-repair-points-2';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.4.15-lineup-workspace-1-points-2',
  './js/app-version.js?v=1.0.35',
  ...
  './js/yahoo-season-v1.js?v=1.4.0-scoring-table-identity-1',
  './js/yahoo-sync-v1.js?v=1.2.2-response-contract',
  './js/season-command-center-v1.js?v=1.1.6-projection-semantics',
  './js/season-home-v3.js?v=1.1.1-preview',
  './js/nfl-live-week-v1.js?v=1.0.0',
  './js/sleeper-projection-adapter-v1.js?v=1.0.0-identity-1',
  './js/season-current-week-evidence-v1.js?v=1.2.1',
  './js/manual-season-state-v1.js?v=1.0.0',
  './js/waiver-transaction-quality-v1.js?v=1.0.0',
  './js/waiver-intelligence-v1.js?v=1.1.0-identity-1',
  './js/weekly-matchup-intelligence-v1.js?v=1.0.0',
  './js/start-sit-intelligence-v1.js?v=1.2.1',
  './js/teamfit-v1.js?v=1.0.0',
  './js/season-evidence-v1.js?v=1.2.0',
  ...
  './js/discovery-breakout-radar-v1.js?v=1.0.1',
  './js/faab-intelligence-v1.js?v=1.1.0',
  './js/weekly-command-center-v1.js?v=1.1.2',
  ...
  './js/lineup-preview-v1.js?v=1.0.1',
  './js/lineup-workspace-ui.js?v=1.0.3',
  './js/app.js?v=4.4.15-lineup-workspace-1-identity-1-points-2',
  ...
  './tests/fixtures/discovery_radar_4_4_10.json',
  './tests/fixtures/weekly_matchup_intelligence_4_4_11.json',
  ...
  './data/rankings/fantasyland_draftday_2026-09-02.normalized.json',
  './data/rankings/flock_draftday_2026-09-02.normalized.json',
  './data/rankings/draftday_rankings_manifest_2026-09-02.json',
  ...
  './data/season_evidence/nflverse_participation_latest.json',
