const CACHE = 'fantasy-hq-jonin-4-4-11-2-season-command-center-v1-2026-09-12';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.4.11.2',
  ...
  './js/season-command-center-v1.js?v=1.1.3',
  ...
  './js/start-sit-intelligence-v1.js?v=1.1.0',
