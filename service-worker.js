const CACHE = 'fantasy-hq-jonin-4-4-15-lineup-workspace-2026-09-24-lock-safety';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.4.15-lineup-workspace-1',
  ...
  './js/yahoo-season-v1.js?v=1.4.0-scoring-table',
  ...
  './js/sleeper-projection-adapter-v1.js?v=1.0.0',
  ...
  './js/lineup-workspace-ui.js?v=1.0.1',
  './js/app.js?v=4.4.15-lineup-workspace-1',
