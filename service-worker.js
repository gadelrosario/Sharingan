const CACHE = 'fantasy-hq-jonin-4-4-11-3-start-sit-season-live-intelligence-v1-2026-09-18';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.4.11.3',
  './js/app-version.js?v=1.0.30',
  ...
  './js/yahoo-season-v1.js?v=1.1.0',
  './js/yahoo-sync-v1.js?v=1.1.0',
  './js/season-command-center-v1.js?v=1.1.4',
  ...
  './js/start-sit-intelligence-v1.js?v=1.2.0',
  ...
  './js/weekly-command-center-v1.js?v=1.1.0',
  ...
  './js/app.js?v=4.4.11.3-season-live-1',
