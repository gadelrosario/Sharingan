const CACHE = 'fantasy-hq-jonin-4-2-4';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.2.0',
  './js/app-version.js?v=1.0.6',
  './js/player-tier-contract.js?v=1.0.0',
  './js/specialist-rankings-v1.js?v=1.0.0',
  './js/draft-math-v1.js?v=1.0.0',
  './js/injury-intelligence-v1.js?v=1.1.0',
  './js/espn-injury-adapter-v1.js?v=1.0.0',
  './js/sleeper-injury-adapter-v1.js?v=1.0.0',
  ...
  './js/jonin-decision-intelligence-v1.js?v=1.0.2',
