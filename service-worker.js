const CACHE = 'fantasy-hq-jonin-4-4-14-sleeper-projection-2026-09-23';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.4.13-live-player-intelligence-1',
  './js/app-version.js?v=1.0.34',
  ...
  './js/season-current-week-evidence-v1.js?v=1.2.0',
  ...
  './js/app.js?v=4.4.14-sleeper-projection-1',
