const CACHE = 'fantasy-hq-jonin-4-4-10-discovery-radar-v1-2026-08-28';
const ASSETS = [
  './',
  './index.html',
  './css/app.css?v=4.4.10.0',
  './js/app-version.js?v=1.0.26',
  ...
  './js/discovery-breakout-radar-v1.js?v=1.0.0',
