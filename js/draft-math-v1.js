(function(root){
  'use strict';
  const supported=new Set([8,9,10,11,12,13,14,15,16]);
  function leagueSize(value){const size=Number(value);if(!supported.has(size))throw new RangeError('League size must be a whole number from 8 through 16.');return size}
