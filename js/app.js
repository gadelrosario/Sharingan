...
if("serviceWorker" in navigator){window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker.js?v=jonin_3_4_1").then(reg=>reg.update()).catch(err=>console.warn("Service worker update skipped",err)))}
init();
