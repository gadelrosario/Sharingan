...
let yahooSyncController=null,yahooDiscoveredLeagues=[],seasonDemoSnapshot=null,seasonEvidenceFixture=null,seasonInjuryOpportunityFixture=null,seasonEvidenceStore=null,seasonInjuryOpportunityEngine=null,seasonPage='home',seasonWeekOverride=null,seasonSelectedPlayer=null;
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () =>
    navigator.serviceWorker
      .register('./service-worker.js?v=jonin_4_4_7_faab_intelligence')
      .then(reg => reg.update())
