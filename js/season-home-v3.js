(function(root,factory){
  ...
  const projection=player=>finite(player?.currentWeek ? player.currentWeek.outlookContribution?.value : player?.projection??player?.projectedPoints??player?.yahooProjection);
