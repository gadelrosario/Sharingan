...
const report=inventory.audit(players,injuries,{contextSnapshot:optional('player_context_2026.json'),projectionSnapshot:optional('projection_market_2026.json'),historicalSnapshot:optional('historical_usage_2023_2025.json')});
