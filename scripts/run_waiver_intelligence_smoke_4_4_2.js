...
if(!html.includes('js/waiver-transaction-quality-v1.js?v=1.0.0')||!html.includes('js/waiver-intelligence-v1.js?v=1.1.0'))throw new Error('Waiver transaction and intelligence modules are not loaded before the app.');
