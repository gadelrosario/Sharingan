...
"""
    ...
    def test_deployed_assets_activate_the_flight_control_renderer(self):
        ...
        self.assertIn('css/app.css?v=4.3.12', html)
        ...
        self.assertIn('service-worker.js?v=jonin_4_3_12', app)
        self.assertIn('fantasy-hq-jonin-4-3-12', worker)
        for asset in ('css/app.css?v=4.3.12', 'js/app-version.js?v=1.0.13', 'js/flight-control-v1.js?v=1.3.0', 'js/adaptive-coaching-engine-v1.js?v=1.0.0', 'js/premium-player-card-v1.js?v=1.1.0', 'js/draft-psychology-engine-v1.js?v=1.0.0', 'js/app.js?v=4.3.12'):
