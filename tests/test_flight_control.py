...
"""
    ...
    def test_deployed_assets_activate_the_flight_control_renderer(self):
        ...
        self.assertIn('css/app.css?v=3.7.1', html)
        ...
        self.assertIn('js/app.js?v=3.7.1', html)
        self.assertIn('service-worker.js?v=jonin_3_4_1', app)
        self.assertIn('fantasy-hq-jonin-3-4-1', worker)
        for asset in ('css/app.css?v=3.7.1', 'js/flight-control-v1.js?v=1.3.0', 'js/adaptive-coaching-engine-v1.js?v=1.0.0', 'js/premium-player-card-v1.js?v=1.0.0', 'js/app.js?v=3.7.1'):
