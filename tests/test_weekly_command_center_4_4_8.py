...
class WeeklyCommandCenter448Tests(unittest.TestCase):
    ...
    def test_browser_integration_is_downstream_and_cached(self):
        ...
        self.assertIn('js/weekly-command-center-v1.js?v=1.1.2', html)
    ...
    def test_season_home_convergence_contracts(self):
        ...
        self.assertIn("css/app.css?v=4.4.11.4-correction-2", html)
        self.assertIn("js/app.js?v=4.4.11.4-season-home-v3-5-projection-semantics", html)
