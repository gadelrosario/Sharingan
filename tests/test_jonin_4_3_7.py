...
class Jonin437Tests(unittest.TestCase):
    ...
    def test_profile_module_is_loaded_before_app_and_cached(self):
        ...
        self.assertLess(html.index('js/league-profiles-v1.js'),html.index('js/app.js?v=4.3.7'))
    ...
    def test_profile_specific_context_reaches_existing_engine_inputs(self):
        ...
        for token in ("...activeProfileSettings()","leagueContext.scoring === 'full'","leagueContext.passTD === 6","startRB:leagueContext.startRB","startWR:leagueContext.startWR","flex:leagueContext.flex"):
