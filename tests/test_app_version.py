...
"""
        ...
        self.assertEqual(json.loads(result.stdout), {"phase": "Jōnin", "milestone": "4.3.4", "label": "Jōnin 4.3.4"})
...
"""
    ...
    def test_one_browser_source_owns_visible_version_literal(self):
        ...
        self.assertEqual(version.count("label:'Jōnin 4.3.4'"), 1)
        for source in (html, app, manifest, worker):
            self.assertNotIn("Jōnin 4.3.4", source)
