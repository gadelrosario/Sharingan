...
"""
        ...
        self.assertEqual(json.loads(result.stdout), {"phase": "Jōnin", "milestone": "4.4.14", "label": "Jōnin 4.4.14"})
...
"""
    ...
    def test_one_browser_source_owns_visible_version_literal(self):
        ...
        self.assertEqual(version.count("label:'Jōnin 4.4.14'"), 1)
        for source in (html, app, manifest, worker):
            self.assertNotIn("Jōnin 4.4.14", source)
    ...
    def test_offline_cache_contains_canonical_metadata(self):
        ...
        app = (ROOT / "js" / "app.js").read_text(encoding="utf-8")
        html = (ROOT / "index.html").read_text(encoding="utf-8")
        self.assertIn('js/app-version.js?v=1.0.34', html)
        self.assertIn('./js/app-version.js?v=1.0.34', worker)
        self.assertIn('fantasy-hq-jonin-4-4-14-sleeper-projection', worker)
        self.assertIn('service-worker.js?v=jonin_4_4_14_sleeper_projection_1', app)
        self.assertIn('css/app.css?v=4.4.13-live-player-intelligence-1', worker)
        ...
        self.assertIn('js/start-sit-intelligence-v1.js?v=1.2.1', worker)
        ...
        self.assertIn('js/nflverse-evidence-adapter-v1.js?v=1.1.0', worker)
        ...
        self.assertIn('js/weekly-command-center-v1.js?v=1.1.2', worker)
        self.assertIn('js/nfl-live-week-v1.js?v=1.0.0', worker)
        self.assertIn('js/sleeper-projection-adapter-v1.js?v=1.0.0', worker)
        self.assertIn('js/season-current-week-evidence-v1.js?v=1.2.0', worker)
        self.assertIn('js/app.js?v=4.4.14-sleeper-projection-1', worker)
