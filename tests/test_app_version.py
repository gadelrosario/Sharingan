...
"""
        ...
        self.assertEqual(json.loads(result.stdout), {"phase": "Jōnin", "milestone": "4.3.8", "label": "Jōnin 4.3.8"})
...
"""
    ...
    def test_one_browser_source_owns_visible_version_literal(self):
        ...
        self.assertEqual(version.count("label:'Jōnin 4.3.8'"), 1)
        for source in (html, app, manifest, worker):
            self.assertNotIn("Jōnin 4.3.8", source)
